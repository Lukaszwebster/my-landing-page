<template>
  <div class="mx-4 font-roboto 2xl:mx-[300px] lg:mx-[80px]">
    <img class="absolute top-0 opacity-40% -z-10" src="/background.svg" alt="">
      ...
      <div class="sm:flex sm:justify-between">
        ...
        <div class="lg:max-w-550px md:max-w-400px sm:max-w-500px xl:max-w-700px">
          ...
          <h2 class="mt-10 leading-loose text-gray-500 md:ml-[30px] sm:text-right">
            ...
            <br>
            Prywatnie - fan motoryzacji, pasjonat foto/video, miłośnik narciarstwa/kolarstwa oraz gier komputerowych.
          </h2>
        </div>
      </div>
    </div>

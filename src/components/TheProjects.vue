  ...
  <div class="mx-4 mt-20 items-center font-roboto 2xl:mx-[300px] lg:mx-[80px] md:mt-30">
    ...
    <div data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="800" class="mt-20 flex flex-col items-center justify-center md:mt-30">
      ...
      <h2 class="class= mt-4 leading-loose text-gray md:max-w-800px">
        Aplikacja pogodowa pokazująca aktualne dane pogodowe miast. W krótce będzie rozbudowywana.
      </h2>
      <picture class="mt-8">
        <a href="" /><img class="max-w-300px rounded-10px" src="/weatherApp.png" alt="">
      </picture>
    </div>
